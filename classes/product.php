...
<?php 
	...
	*/
	class product
	{
		...
		public function show_product_user($tukhoa){
		...
		// san phẩm mới
		public function getproduct_featheread1()
		{
		...
		// san pham noibat
		public function getproduct_featheread2()
		{
			$query = "SELECT * FROM `tbl_product` LIMIT 4 OFFSET 3";
			$result = $this->db->select($query);
			return $result;
		}
		//
