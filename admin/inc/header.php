    ...
    <div class="container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft logo">
                    <img src="img/logo1.jpg" alt="Logo" height="50px"/>
				</div>
				<div class="floatleft middle">
					<h1>NN SHOP</h1>
					<p>www.nnshopbandan.com</p>
				</div>
        ...
        <div class="grid_12">
            <ul class="nav main">
				...
				<li class="ic-grid-tables"><a href="lhelist.php"><span>Hộp thư đến</span></a></li>
                <li class="ic-charts"><a href=""><span>Cài đặt</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>
